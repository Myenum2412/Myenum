...
export const testimonials = [
  ...
  {
    quote:
    "iSTAYS, founded in 2020 by Chef Balamurugan Kathavaryan(Sir), offers unique home-stay experiences in South India, blending culinary expertise with warm hospitality.",
    name: "Ihotels",
