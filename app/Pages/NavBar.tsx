  ...
  return (
    <>
      ...
      <a href="https://www.myenum.in">
        ...
        <RainbowButton className="rounded-full font-semibold max-sm:hidden bg-black text-black transition-colors duration-300">
  <a href="https://calendly.com/myenumam">Connect Now</a>
</RainbowButton>


        <div className="hidden max-sm:block bg-dark">
