...
export function DraggableCardDemo() {
  const items = [
    ...
    {
      title: "Company Growth Advisor (Anupama)",
      image:
        "https://n876yi368y.ufs.sh/f/rkfoB8QIhcPLgwFMUiNnAnjpxS2sbrJcOT7qFB6Ngm9yiokW",
      className: "absolute top-20 right-[50%] rotate-[2deg]",
    },
    {
