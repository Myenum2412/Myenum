...
function ServicesSelection({ className = '' }: ContainerProps) {
  return (
    <>
  ...
  <FlipText className="text-4xl font-bold -tracking-widest text-white dark:text-white md:text-7xl md:leading-[5rem]">Services</FlipText>
      ...
      <div className="content text-left pl-5 mt-10">
  ...
  <div className="flex flex-col md:flex-row items-center gap-10">
    ...
    <div className="md:w-1/2 w-full text-left">
      ...
      <p className="text-2xl mt-4">
        A website is the foundation of any online business. We offer fully customized website development services to ensure that your online presence aligns with your brand identity and business objectives. Our custom website development includes:
      </p>
      ...
      <div className="content text-left">
        <h3 className="text-6xl font-bold pt-6">E-Commerce Solutions</h3>
        <p className="text-2xl">
...
<div className="content text-left">
          ...
          <ul className="list-disc list-inside mt-2 text-2xl">
            ...
            <li><strong>Brand Identity Integration:</strong> We create designs that reflect your brands personality, ensuring consistency in colors, typography, and visual elements.</li>
          </ul>
        </div>
      ...
      <div className="content text-left">
        ...
        <ul className="list-disc list-inside mt-2 text-2xl">
          ...
          <li><strong>Content Updates:</strong> Need to update product details, blog posts, or landing pages? We have got you covered.</li>
  ...
  <h6 className="text-4xl font-bold mt-6">SEO Services:</h6>
  <ul className="list-disc list-inside mt-2 text-2xl">
  ...
  <h5 className="text-4xl font-bold mt-6">Digital Marketing Services:</h5>
  <ul className="list-disc list-inside mt-2 text-2xl">
...
<div className="content text-left">
  ...
  <p className="text-2xl">
    At Myenum, we specialize in supporting startups by providing digital solutions that are custom-built to match your unique vision and goals. We know that launching a business comes with uncertainty, tight budgets, and high expectations — that's why we focus on delivering high-impact websites and applications that are scalable, cost-effective, and designed to grow with you.
  </p>
