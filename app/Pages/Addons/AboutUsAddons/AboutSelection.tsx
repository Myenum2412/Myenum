...
import { SpinningTextBasic } from "@/app/Pages/Addons/HomeAddons/SpinningTextBasic";
...
const Container: React.FC<ContainerProps> = ({ children, className = "" }) => {
  ...
  <FlipText className="text-4xl font-bold -tracking-widest text-white dark:text-white md:text-7xl md:leading-[5rem]">About Us</FlipText>
      ...
      <div className="content text-left">
        ...
        <p className="text-2xl">Myenum was founded with a bold vision to bridge the gap between businesses and digital success. At the heart of this vision is Kishor, a leader with a passion for innovation, technology, and business growth. He is also an active BNI Member in the <LinkPreview url="https://bni-salem.in/en-IN/memberdetails?encryptedMemberId=VyR43%2BVKzpyWOMxTHyv88A%3D%3D&name=Kishor+M+K" className="font-bold text-red-500">BNI Happy Chapter</LinkPreview>, where he collaborates with like-minded entrepreneurs and professionals to drive business success through networking, referrals, and strategic partnerships.</p>
        <p className="text-2xl mt-6">Under <LinkPreview url="https://www.linkedin.com/in/Kishor-mk/" className="font-bold text-blue-500">Kishor’s leadership</LinkPreview> Myenum has carved a niche in providing customized solutions that cater to both B2B and B2C markets. Understanding that no two businesses are the same, we work closely with our clients to create strategic, tailor-made websites that align with their brand, industry demands, and customer expectations.</p>
      ...
      <ul className="list-disc list-inside mt-2 text-2xl">
        ...
        <li><strong>Strong Business Network</strong> – With Kishor’s active involvement in <LinkPreview url="https://bni-salem.in/en-IN/memberdetails?encryptedMemberId=VyR43%2BVKzpyWOMxTHyv88A%3D%3D&name=Kishor+M+K" className="font-bold text-red-500">BNI Happy Chapter</LinkPreview>, we leverage a powerful network of business leaders to create meaningful connections and </li>
      </ul>
      </div>
