...
const Container: React.FC<ContainerProps> = ({ children, className = "" }) => {
  ...
  <FlipText className="text-4xl font-bold -tracking-widest text-white dark:text-white md:text-7xl md:leading-[5rem]">About Us</FlipText>
      ...
      <div className="content text-left">
        ...
        <p className="text-2xl mt-6">Under <LinkPreview url="https://www.linkedin.com/in/Amarnath-mk/"> <span className="font-bold text-blue-500">Amarnath’s leadership</span></LinkPreview> Myenum has carved a niche in providing customized solutions that cater to both B2B and B2C markets. Understanding that no two businesses are the same, we work closely with our clients to create strategic, tailor-made websites that align with their brand, industry demands, and customer expectations.</p>
        ...
        <div className="md:w-1/2 w-full">
          <div className="relative w-full h-[800px]">
            <Image 
              ...
              className="rounded-2xl"
            />
            <div className="relative bg-white rounded-2xl mt-10">
