...
import SpotifyBlogs from './SpotifyBlogs';
...
function page() {
  return (
    ...
    <div className="container mx-auto p-4 w-full h-full bg-cover bg-center flex flex-col items-center justify-center gap-4">
      ...
      {/* Centered Text */}
      <FlipText className="text-4xl font-bold -tracking-widest text-white dark:text-white md:text-7xl md:leading-[5rem]">Spotify Ads...</FlipText>
      </div>
